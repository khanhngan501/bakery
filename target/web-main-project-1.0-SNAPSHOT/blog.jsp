      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center mb-5">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="ProductControl?action=home">Home <i class="fa fa-chevron-right"></i></a></span> <span>Blog <i class="fa fa-chevron-right"></i></span></p>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="blog-entry">
            ...
            <div class="text px-4 pt-3 pb-4">
              ...
              <div class="blog-landing-article-excerpt small-paragraph">
                <p>Croquettes are the ultimate labor of love. There is nothing quite like a croquette—the dish is simple and in the best way. This food always seems to remind y...</p>
              </div>
              <p class="clearfix">
        ...
        <div class="col-md-4 ftco-animate">
          <div class="blog-entry">
            ...
            <div class="text px-4 pt-3 pb-4">
              ...
              <div class="blog-landing-article-excerpt small-paragraph">
                <p>Serrano peppers can be pretty mysterious. They might look like your average pepper, but what people don’t know is that these peppers can really pack a punch...</p>
              </div>
              <p class="clearfix">
                <a href="blog-single.jsp" class="float-left read btn btn-primary">Read more</a>
                <a href="blog-single.jsp" class="float-right meta-chat"><span class="fa fa-comment"></span> 3</a>
